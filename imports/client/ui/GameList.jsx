...
import { Game, getGameStateString, initialGame } from '../../api/game.js';
            ...
            <div className="column is-4">
                <div className="card">
                    ...
                    <div className="card-content">
                        <div className="content">
                            <ul>
                                ...
                                <li>Time
                                    Paused: {formatTimeNumber(pauseDuration.hours())}:{formatTimeNumber(pauseDuration.minutes())}:{formatTimeNumber(pauseDuration.seconds())}</li>
                            </ul>
                        </div>
                    </div>
                    <footer className="card-footer">
                        ...
                        <a onClick={this.onDelete} href="#" className="card-footer-item has-text-danger">Delete</a>
                    </footer>
                </div>
            </div>
        );
